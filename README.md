...
**10 open roles · 4004 companies tracked · updated Jul 31, 2026 at 17:25 UTC**
...
| --- | --- | --- | --- | --- | --- | --- |
| Fidelity Investments | AI Product / Business Intern | Durham, NC (Hybrid) | Aug 25, 2025 *(seeded estimate)* | ~Aug 25 · in ~24d | ⏳ waiting | shown when posting goes live |
| Truist | AI Governance / Business Intern | Raleigh, NC (Hybrid) | Sep 02, 2025 *(seeded estimate)* | ~Sep 02 · in ~32d | ⏳ waiting | shown when posting goes live |
| Cisco | AI Go-To-Market Intern | RTP, NC (Hybrid) | Sep 08, 2025 *(seeded estimate)* | ~Sep 08 · in ~38d | ⏳ waiting | shown when posting goes live |
| SAS Institute | AI & Analytics Intern (business track) | Cary, NC (Hybrid) | Sep 08, 2025 *(seeded estimate)* | ~Sep 08 · in ~38d | ⏳ waiting | shown when posting goes live |
| IBM | AI Consulting Intern (RTP) | RTP, NC (Hybrid) | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~45d | ⏳ waiting | shown when posting goes live |
| Lenovo | AI Strategy / Marketing Intern | Morrisville, NC (Hybrid) | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~45d | ⏳ waiting | shown when posting goes live |
| MetLife | AI Enablement Intern (Global Technology Campus) | Cary, NC (Hybrid) | Sep 22, 2025 *(seeded estimate)* | ~Sep 22 · in ~52d | ⏳ waiting | shown when posting goes live |
| Red Hat | AI Marketing / Program Intern | Raleigh, NC (Hybrid) | Sep 29, 2025 *(seeded estimate)* | ~Sep 29 · in ~59d | ⏳ waiting | shown when posting goes live |
...
| Company | Typical Role | Location | Last Cycle's First Post | Expected This Cycle | Status | Graduation Req. |
| --- | --- | --- | --- | --- | --- | --- |
| Deloitte | AI & Data Strategy Intern | Remote — US | Aug 18, 2025 *(seeded estimate)* | ~Aug 18 · in ~17d | ⏳ waiting | shown when posting goes live |
| Procter & Gamble | Brand / AI Innovation Intern | Remote — US | Aug 18, 2025 *(seeded estimate)* | ~Aug 18 · in ~17d | ⏳ waiting | shown when posting goes live |
| EY | AI Consulting Intern | Remote — US | Aug 25, 2025 *(seeded estimate)* | ~Aug 25 · in ~24d | ⏳ waiting | shown when posting goes live |
| KPMG | AI Advisory Intern | Remote — US | Sep 02, 2025 *(seeded estimate)* | ~Sep 02 · in ~32d | ⏳ waiting | shown when posting goes live |
| PwC | AI Assurance / Advisory Intern | Remote — US | Sep 08, 2025 *(seeded estimate)* | ~Sep 08 · in ~38d | ⏳ waiting | shown when posting goes live |
| Walmart | AI Business Intern | Remote — US | Sep 08, 2025 *(seeded estimate)* | ~Sep 08 · in ~38d | ⏳ waiting | shown when posting goes live |
| Accenture | AI Strategy Intern | Remote — US | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~45d | ⏳ waiting | shown when posting goes live |
| Salesforce | AI (Agentforce) Product Marketing Intern | Remote — US | Sep 22, 2025 *(seeded estimate)* | ~Sep 22 · in ~52d | ⏳ waiting | shown when posting goes live |
| ServiceNow | AI Product Marketing Intern | Remote — US | Sep 29, 2025 *(seeded estimate)* | ~Sep 29 · in ~59d | ⏳ waiting | shown when posting goes live |
...
*Engine (last run): 4,004 companies polled across 11 job platforms · 94% fetch success · completed in 117s.*
