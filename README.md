...
**9 open roles · 4758 companies tracked · updated Sep 08, 2026 at 19:12 UTC**
...
| IBM | AI Consulting Intern (RTP) | RTP, NC (Hybrid) | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~6d | ⏳ waiting | shown when posting goes live |
| Lenovo | AI Strategy / Marketing Intern | Morrisville, NC (Hybrid) | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~6d | ⏳ waiting | shown when posting goes live |
| MetLife | AI Enablement Intern (Global Technology Campus) | Cary, NC (Hybrid) | Sep 22, 2025 *(seeded estimate)* | ~Sep 22 · in ~13d | ⏳ waiting | shown when posting goes live |
| Red Hat | AI Marketing / Program Intern | Raleigh, NC (Hybrid) | Sep 29, 2025 *(seeded estimate)* | ~Sep 29 · in ~20d | ⏳ waiting | shown when posting goes live |
| First Citizens Bank | AI Operations Intern | Raleigh, NC (Hybrid) | Oct 06, 2025 *(seeded estimate)* | ~Oct 06 · in ~27d | ⏳ waiting | shown when posting goes live |
| IQVIA | AI Commercial Solutions Intern | Durham, NC (Hybrid) | Oct 13, 2025 *(seeded estimate)* | ~Oct 13 · in ~34d | ⏳ waiting | shown when posting goes live |
| Blue Cross NC | AI Strategy Intern | Durham, NC (Hybrid) | Oct 20, 2025 *(seeded estimate)* | ~Oct 20 · in ~41d | ⏳ waiting | shown when posting goes live |
| Labcorp | AI Operations Intern | Durham, NC (Hybrid) | Oct 27, 2025 *(seeded estimate)* | ~Oct 27 · in ~48d | ⏳ waiting | shown when posting goes live |
| Advance Auto Parts | AI Business Intern | Raleigh, NC (Hybrid) | Nov 03, 2025 *(seeded estimate)* | ~Nov 03 · in ~55d | ⏳ waiting | shown when posting goes live |
...
| Accenture | AI Strategy Intern | Remote — US | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~6d | ⏳ waiting | shown when posting goes live |
| Salesforce | AI (Agentforce) Product Marketing Intern | Remote — US | Sep 22, 2025 *(seeded estimate)* | ~Sep 22 · in ~13d | ⏳ waiting | shown when posting goes live |
| ServiceNow | AI Product Marketing Intern | Remote — US | Sep 29, 2025 *(seeded estimate)* | ~Sep 29 · in ~20d | ⏳ waiting | shown when posting goes live |
| Adobe | AI Marketing Intern | Remote — US | Oct 06, 2025 *(seeded estimate)* | ~Oct 06 · in ~27d | ⏳ waiting | shown when posting goes live |
| Scale AI | AI Operations / GTM Intern | Remote — US | Oct 13, 2025 *(seeded estimate)* | ~Oct 13 · in ~34d | ⏳ waiting | shown when posting goes live |
| CVS Health | AI Adoption Intern | Remote — US | Oct 20, 2025 *(seeded estimate)* | ~Oct 20 · in ~41d | ⏳ waiting | shown when posting goes live |
| PepsiCo | Commercial AI Intern | Remote — US | Oct 27, 2025 *(seeded estimate)* | ~Oct 27 · in ~48d | ⏳ waiting | shown when posting goes live |
...
*Engine (last run): 4,758 companies polled across 11 job platforms · 94% fetch success · completed in 129s.*
