...
**9 open roles · 4831 companies tracked · updated Sep 14, 2026 at 22:54 UTC**
...
| IBM | AI Consulting Intern (RTP) | RTP, NC (Hybrid) | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~0d | ⏳ waiting | shown when posting goes live |
| Lenovo | AI Strategy / Marketing Intern | Morrisville, NC (Hybrid) | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~0d | ⏳ waiting | shown when posting goes live |
| MetLife | AI Enablement Intern (Global Technology Campus) | Cary, NC (Hybrid) | Sep 22, 2025 *(seeded estimate)* | ~Sep 22 · in ~7d | ⏳ waiting | shown when posting goes live |
| Red Hat | AI Marketing / Program Intern | Raleigh, NC (Hybrid) | Sep 29, 2025 *(seeded estimate)* | ~Sep 29 · in ~14d | ⏳ waiting | shown when posting goes live |
| First Citizens Bank | AI Operations Intern | Raleigh, NC (Hybrid) | Oct 06, 2025 *(seeded estimate)* | ~Oct 06 · in ~21d | ⏳ waiting | shown when posting goes live |
| IQVIA | AI Commercial Solutions Intern | Durham, NC (Hybrid) | Oct 13, 2025 *(seeded estimate)* | ~Oct 13 · in ~28d | ⏳ waiting | shown when posting goes live |
| Blue Cross NC | AI Strategy Intern | Durham, NC (Hybrid) | Oct 20, 2025 *(seeded estimate)* | ~Oct 20 · in ~35d | ⏳ waiting | shown when posting goes live |
| Labcorp | AI Operations Intern | Durham, NC (Hybrid) | Oct 27, 2025 *(seeded estimate)* | ~Oct 27 · in ~42d | ⏳ waiting | shown when posting goes live |
| Advance Auto Parts | AI Business Intern | Raleigh, NC (Hybrid) | Nov 03, 2025 *(seeded estimate)* | ~Nov 03 · in ~49d | ⏳ waiting | shown when posting goes live |
| RTI International | AI Policy / Research Support Intern | RTP, NC (Hybrid) | Nov 10, 2025 *(seeded estimate)* | ~Nov 10 · in ~56d | ⏳ waiting | shown when posting goes live |
...
| Accenture | AI Strategy Intern | Remote — US | Sep 15, 2025 *(seeded estimate)* | ~Sep 15 · in ~0d | ⏳ waiting | shown when posting goes live |
| Salesforce | AI (Agentforce) Product Marketing Intern | Remote — US | Sep 22, 2025 *(seeded estimate)* | ~Sep 22 · in ~7d | ⏳ waiting | shown when posting goes live |
| ServiceNow | AI Product Marketing Intern | Remote — US | Sep 29, 2025 *(seeded estimate)* | ~Sep 29 · in ~14d | ⏳ waiting | shown when posting goes live |
| Adobe | AI Marketing Intern | Remote — US | Oct 06, 2025 *(seeded estimate)* | ~Oct 06 · in ~21d | ⏳ waiting | shown when posting goes live |
| Scale AI | AI Operations / GTM Intern | Remote — US | Oct 13, 2025 *(seeded estimate)* | ~Oct 13 · in ~28d | ⏳ waiting | shown when posting goes live |
| CVS Health | AI Adoption Intern | Remote — US | Oct 20, 2025 *(seeded estimate)* | ~Oct 20 · in ~35d | ⏳ waiting | shown when posting goes live |
| PepsiCo | Commercial AI Intern | Remote — US | Oct 27, 2025 *(seeded estimate)* | ~Oct 27 · in ~42d | ⏳ waiting | shown when posting goes live |
...
*Engine (last run): 4,831 companies polled across 11 job platforms · 95% fetch success · completed in 131s.*
